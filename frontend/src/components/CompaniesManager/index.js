              ...
              <Grid xs={12} sm={6} md={4} item>
                <Field name="primaryColor">
                  {({ field, form }) => (
                    <>
                      <TextField
                        label="Cor Principal do Template"
                        name="primaryColor"
                        id="primaryColor"
                        value={field.value || "#2DDD7F"}
                        InputProps={{
                          startAdornment: (
                            <InputAdornment position="start">
                              <div
                                style={{ backgroundColor: field.value || "#2DDD7F" }}
                      ...
                      <ColorPicker
                        ...
                        currentColor={field.value || "#2DDD7F"}
                      />
                    </>
                  )}
                </Field>
...
//    }
    ...
    setRecord((prev) => ({
      ...
      primaryColor: data.primaryColor || "#2DDD7F",
    }));
  };
