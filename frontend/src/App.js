...
import "./assets/company-theme.css";
    ...
    const theme = createTheme(
        {
            ...
            palette: {
                type: mode,
                primary: { main: mode === "light" ? companyColor : "#FFFFFF" },
				sair: { main: mode === "light" ? companyColor : "#333" },
				vcard: { main: mode === "light" ? companyColor : "#666" },
                textPrimary: mode === "light" ? companyColor : "#FFFFFF",
                borderPrimary: mode === "light" ? companyColor : "#FFFFFF",
                dark: { main: mode === "light" ? "#333333" : "#F3F3F3" },
                light: { main: mode === "light" ? "#F3F3F3" : "#333333" },
                tabHeaderBackground: mode === "light" ? "#EEE" : "#666",
                optionsBackground: mode === "light" ? "#fafafa" : "#333",
				options: mode === "light" ? "#fafafa" : "#666",
				fontecor: mode === "light" ? companyColor : "#fff",
                ...
                barraSuperior: mode === "light" ? `linear-gradient(to right, ${companyColor}, ${companyColor} , ${companyColor})` : "#666",
